...
namespace TaiwanPetroUWP
{
    ...
    public sealed partial class LocationPage : Page
    {
        ...
        private void dialstation_Click(object sender, RoutedEventArgs e)
        {
            Windows.ApplicationModel.Calls.PhoneCallManager.ShowPhoneCallUI(((stationStorage)((MenuFlyoutItem)sender).DataContext).phone, ((stationStorage)((MenuFlyoutItem)sender).DataContext).name);
        }
